...
WORK_DIR_BBSPLIT="/data/local/MD_project/scripts/pipelines/exome_final/work_bbsplit_2"
WORK_DIR_SAREK="/data/local/MD_project/scripts/pipelines/exome_final/work_sarek_2_all"
...
RESULTS_BBSPLIT_DIR="/data/local/MD_project/data/exome/processed_final/02_bbsplit_all_minid"
...
#bbmap.sh ref=$FASTA_HUMAN build=1 #Numeric id is 1
#bbmap.sh ref=$FASTA_MOUSE build=2 # Numeric id is 2?
FASTA_MOUSE="/data/local/reference/aws/igenomes/Mus_musculus/Ensembl/GRCm38/Sequence/WholeGenomeFasta/genome.fa"
FASTA_HUMAN="/data/local/reference/aws/igenomes/Homo_sapiens/GATK/GRCh38/Sequence/WholeGenomeFasta/Homo_sapiens_assembly38.fasta"


nextflow run /data/local/MD_project/scripts/pipelines/exome_final/steps/02_bbsplit/bbsplit.nf \
--FASTA_HUMAN $FASTA_HUMAN \
--FASTA_MOUSE $FASTA_MOUSE \
--BBSPLIT_DIR $RESULTS_BBSPLIT_DIR  \
-work-dir $WORK_DIR_BBSPLIT


#03_Prepare Samplesheets
samplesheet_path="/data/local/MD_project/scripts/pipelines/exome_final/steps/02b_samplesheets/samplesheets/exome_final_samplesheet_bbsplit_rerun_all.csv"
#SAREK
...
#--tools mutect2,cnvkit,vep --wes \
#--outdir "/data/local/MD_project/data/exome/processed_final/sarek_2_all"  \
#-work-dir $WORK_DIR_SAREK

#Removed haplotypecaller, msisensorpro, added vep
...
# --max_memory '120.GB' \
# --max_cpus 63 -work-dir "/data/local/MD_project/scripts/pipelines/exome_final/work/gatk_filter_all"

 #02_vep
#nextflow run /data/local/MD_project/scripts/pipelines/exome_final/steps/04_vcf_processing/02_vep.nf  -with-singularity $SIF  \
#--max_memory '120.GB' \
#--max_cpus 63 -work-dir "/data/local/MD_project/scripts/pipelines/exome_final/work/vep_all" 
...
#--max_memory '120.GB' \
# --max_cpus 63 \
#-c /data/local/MD_project/scripts/pipelines/exome_final/steps/04_vcf_processing/vcf.config -work-dir "/data/local/MD_project/scripts/pipelines/exome_final/work/vcf2maf_all"
