...
#lig.tumor.cellbender <- readRDS(paste0(outdir,"/lig.tumor.cellbender.rda"))
...
doublet_clusters <- as.numeric(doublet_cluster_fisher[which(
  doublet_cluster_fisher$q < 0.05 & 
    ...
    doublet_cluster_fisher$percent_doublets >= 0.35),]$clus)
...
stopifnot(identical(rownames(lig.tumor.filt@cell.data),rownames(lig.tumor.filt@cell.data)))
lig.tumor.filt@cell.data$in_doublet_cluster <- lig.tumor.filt@cell.data$in_doublet_cluster
lig.tumor.filt@cell.data$is_doublet <- lig.tumor.filt@cell.data$scDblFinder.standard.class=="doublet" | 
